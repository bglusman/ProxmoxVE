#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/bglusman/ProxmoxVE/local_fork/misc/build.func)
...
echo -e "${INFO}${YW} Container Login Credentials:${CL}"
echo -e "${TAB}${GATEWAY}${BGN}Username: root${CL}"
echo -e "${TAB}${GATEWAY}${BGN}Password: storyteller${CL}"